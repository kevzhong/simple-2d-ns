module ghost
    ...
    subroutine update_ghost_wallsU(u,bctype_ubot,bctype_utop,bcval_ubot,bcval_utop)
        ...
        use bctypes
        implicit none
        real(8), intent(inout), dimension(halosize-1:Nx+halosize , halosize-1:Ny+halosize , halosize-1:Nz+halosize ) :: u
    ...
    subroutine update_ghost_wallsW(w,bctype_wbot,bctype_wtop,bcval_wbot,bcval_wtop)
        ...
        use bctypes
        implicit none
        real(8), intent(inout), dimension(halosize-1:Nx+halosize , halosize-1:Ny+halosize , halosize-1:Nz+halosize ) :: w
    ...
    subroutine update_ghost_wallTemp(temp,bctype_Tbot,bctype_Ttop,bcval_Tbot,bcval_Ttop)
        ...
        use bctypes
        implicit none
        real(8), intent(inout), dimension(halosize-1:Nx+halosize , halosize-1:Ny+halosize , halosize-1:Nz+halosize ) :: temp
        ...
        ! Periodicity in y
        temp(:,1-halosize,:) = temp(:,Ny,:)
        temp(:,Ny+halosize,:) = temp(:,1,:)
    ...
    subroutine update_ghost_pressure(p)
        use parameters, only: Nx, Ny, Nz
        implicit none
        real(8), intent(inout), dimension(halosize-1:Nx+halosize , halosize-1:Ny+halosize , halosize-1:Nz+halosize ) :: p
